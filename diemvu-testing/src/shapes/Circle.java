...
public class Circle {
     ...
     * 
     * <p>
     * Precondition: The parameters must not violate the class invariant. That
     * is, theRadius must be greater than zero AND theCenter must not be null
     * AND theColor must not be null
     * </p>
     * 
     ...
     * @throws IllegalArgumentException if theRadius is less than or equal to
     *             zero
    ...
    public Circle(final double theRadius, final Point theCenter, final Color theColor) {
        ...
        /*
         * Note that the Objects class and requireNonNull() were added to Java
         * in version 7. The method will throw an exception if the parameter
         * passed to the method is null. This simplifies the code by eliminating
         * the need for an if / else test and an explicit throws statement.
         */
    ...
    public double calculateArea() {
        return myRadius * myRadius * Math.PI; // Area is radius ^2 * Pi not
                                              // radius * 2 * pi
    ...
    public String toString() {
        final StringBuilder builder = new StringBuilder(128); // default initial
                                                              // size = 16
        builder.append(getClass().getSimpleName()); // the class name without
                                                    // the package name
        builder.append(" [radius=");
        builder.append(String.format("%.2f", myRadius));
        builder.append(", center=");
        builder.append(myCenter);
        // builder.append("(" + myCenter.getX() + ", "+ myCenter.getY() + ")");
